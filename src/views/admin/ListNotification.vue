        ...
        <div class="box-title d-flex justify-content-between">
          <h1 class="title">
            Quản lý danh sách order ({{
              fillterAll ? listNotification.length : fillterItem.length
            }}
            order)
          </h1>
          <div class="d-flex">
                ...
                <CCol lg="7" class="bg-news py-1 text-left">
                  <div class="justify-content-center h-100" style="color: #333">
                    ...
                    <div
                      ...
                      "
                    >
                      <span><div v-html="this.content"></div></span>
                    </div>
                  </div>
                </CCol>
              </CRow>
...
export default {
  ...
  methods: {
    ...
    filterDate() {
      ...
      this.fillterItem = this.listNotification.filter((dt) => {
