...
const TransferHisrtory = () => import("@/views/admin/TransferHistory");
  ...
  return [
    {
      ...
      children: [
        ...
        {
          path: `/${Routes.ADMIN}/${Routes.USER}/${Routes.TRANSFER}/${Routes.HISTORY}/:id`,
          name: "History Transfer User",
          component: TransferHisrtory,
          meta: {
